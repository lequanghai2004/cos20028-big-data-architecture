...
defective2012_tagged = FOREACH defective2012 GENERATE 'ratings_2012.txt' AS filename, rank_ratings2012 AS line_number, *;
defective2013_tagged = FOREACH defective2013 GENERATE 'ratings_2013.txt' AS filename, rank_ratings2013 AS line_number, *;
