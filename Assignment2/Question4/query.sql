...
CREATE TABLE lng_id (
    lng_code VARCHAR(255) PRIMARY KEY COLLATE utf8_bin,
...
CREATE TABLE lng_name (
    lng_name VARCHAR(255) PRIMARY KEY COLLATE utf8_bin
);

CREATE TABLE lng_synonym (
    lng_synonym VARCHAR(255) PRIMARY KEY COLLATE utf8_bin
);

CREATE TABLE lng_thl (
    lng_thl VARCHAR(255) PRIMARY KEY COLLATE utf8_bin
);

CREATE TABLE lng_thp (
    lng_thp VARCHAR(255) PRIMARY KEY COLLATE utf8_bin
);

CREATE TABLE lng_st (
    lng_st VARCHAR(255) PRIMARY KEY COLLATE utf8_bin
);
